import{a as d,S as m,i as c}from"./assets/vendor-CYMld6vM.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))l(r);new MutationObserver(r=>{for(const o of r)if(o.type==="childList")for(const a of o.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&l(a)}).observe(document,{childList:!0,subtree:!0});function i(r){const o={};return r.integrity&&(o.integrity=r.integrity),r.referrerPolicy&&(o.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?o.credentials="include":r.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function l(r){if(r.ep)return;r.ep=!0;const o=i(r);fetch(r.href,o)}})();const p="52841982-f1748b7cc828c4a83b5032abb",h="https://pixabay.com/api/";function y(e){const t={key:p,q:e,image_type:"photo",orientation:"horizontal",safesearch:!0};return d.get(h,{params:t}).then(i=>i.data.hits).catch(i=>{throw console.error("Error fetching images from Pixabay:",i),new Error("Failed to fetch images from Pixabay.")})}const s=document.querySelector(".gallery"),n=document.querySelector(".loader"),g=new m(".gallery a",{captionsData:"alt",captionDelay:250});function b(e){const t=e.tags.split(",").slice(0,3).join(",");return`
